...
//                         </h4>
//                         <p className="text-white/70 mb-4">
//                             Subscribe to our newsletter for special offers, discount codes, and more.
//                         </p>
...
//                                     className="w-full px-4 py-2 bg-white/10 rounded-md border border-white/20 text-white placeholder:text-white/50 focus:outline-none focus:ring-1 focus:ring-resort-gold"
//                                 />
//                             </div>
//                             <button
//                                 type="submit"
//                                 className="w-full py-2 px-4 bg-resort-gold text-white rounded-md hover:bg-resort-gold/90 transition-colors"
//                             >
//                                 Subscribe
//                             </button>
//                         </form>
